...
export function getAuthUrl(state: string) {
    ...
    const params = new URLSearchParams({
        ...
        state: state,
        scope: "email,ads_management,ads_read,business_management,pages_show_list,pages_manage_metadata,pages_read_engagement,pages_manage_engagement,pages_messaging,instagram_business_basic,instagram_manage_comments,instagram_business_manage_messages",
        response_type: "code",
    });
